...
promise_test(() => {
  ...
  controller.close();
  return readableStreamToArray(rs).then(array => assert_array_equals(array, ['b', 'a'], 'array should contain two chunks'));
...
promise_test(() => {
  ...
  controller.enqueue('a');
  return readableStreamToArray(rs).then(array => assert_array_equals(array, [], 'array should contain no chunks'));
...
promise_test(() => {
  ...
  controller.enqueue('a');
  controller.enqueue('b');
  return readableStreamToArray(rs).then(array => assert_array_equals(array, ['a', 'b'], 'array should contain two chunks'));
...
promise_test(() => {
  ...
  controller.enqueue('a');
  controller.close();
  return readableStreamToArray(rs).then(array => assert_array_equals(array, ['a'], 'array should contain one chunk'));
...
promise_test(t => {
  ...
  return Promise.all([reader.closed, cancelPromise]);
...
promise_test(() => {
  ...
  controller.close();
  return Promise.all([readableStreamToArray(branch1).then(array => assert_array_equals(array, ['a'], 'branch1 should have one chunk')), readableStreamToArray(branch2).then(array => assert_array_equals(array, ['a'], 'branch2 should have one chunk'))]);
