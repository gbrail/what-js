...
test(t => {
  ...
  Object.defineProperty(Object.prototype, 'highWaterMark', {
    set() {
      throw new Error('highWaterMark setter called');
    },
    configurable: true
  });
  ...
  Object.defineProperty(Object.prototype, 'size', {
    set() {
      throw new Error('size setter called');
    },
    configurable: true
  });
  t.add_cleanup(() => {
...
test(t => {
  ...
  var oldWritableStream = WritableStream;
  var getReader = ReadableStream.prototype.getReader;
  var getWriter = WritableStream.prototype.getWriter;
  ...
  assert_not_equals(getReader.call(ts.readable), undefined, 'getReader should work when called on ts.readable');
  assert_not_equals(getWriter.call(ts.writable), undefined, 'getWriter should work when called on ts.writable');
